...
-- Case-insensitive searching UNLESS \C or any capital letters in the search
...
require('lazy').setup({
  ...
  { -- LSP Installation & Configuration (native Neovim 0.11+ approach)
    ...
    dependencies = {
      ...
      -- Configures lua_ls to understand Neovim's Lua API
